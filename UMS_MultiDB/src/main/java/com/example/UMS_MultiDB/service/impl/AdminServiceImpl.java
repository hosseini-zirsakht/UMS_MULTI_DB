...
public class AdminServiceImpl implements AdminService {
    ...
    public AdminServiceImpl(AdminConfig adminConfig, DevPersonRepository devPersonRepository, MainPersonRepository mainPersonRepository, TestPersonRepository testPersonRepository) {
    ...
    public Person register(PersonRequestDTO personRequestDTO, Role role) {
        ...
        return switch (role) {
            ...
            case TEST_USER -> testPersonRepository.save(person);
